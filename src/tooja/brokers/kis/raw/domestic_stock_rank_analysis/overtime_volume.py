...
class OvertimeVolumeRequest(KisBaseModel):
    """요청."""
...
class OvertimeVolumeResponse_Output1Item(KisBaseModel):
    """nested item."""
...
class OvertimeVolumeResponse_Output2Item(KisBaseModel):
    """nested item."""
...
class OvertimeVolumeResponse(KisCommonResponse):
    """응답 본문."""

    output1: OvertimeVolumeResponse_Output1Item | None = None  # 응답상세
    output2: list[OvertimeVolumeResponse_Output2Item] = []  # 응답상세 — array

class OvertimeVolumeExecutor(ApiExecutor[OvertimeVolumeRequest, OvertimeVolumeResponse]):
    ...
    METHOD = "GET"
    RESPONSE_TYPE = OvertimeVolumeResponse
    TR_ID = "FHPST02350000"
